      ...
      >
        <div class="gd-checklist__row">
          ...
          <div v-if="canEdit" class="gd-checklist__actions">
            ...
            >
              <i
                class="fa-solid fa-arrow-up gd-checklist__action-icon"
                aria-hidden="true"
              />
            </Button>
            <Button
            ...
            >
              <i
                class="fa-solid fa-arrow-down gd-checklist__action-icon"
                aria-hidden="true"
              />
            </Button>
            <Button
            ...
            >
              <i
                class="fa-solid fa-xmark gd-checklist__action-icon"
                aria-hidden="true"
              />
            </Button>
          </div>
...
function addItem() {
  checkedItems.value.push({ key: '', value: false })
  persist()
}
function handleCheckboxClicked(i) {
  checkedItems.value[i].value = !checkedItems.value[i].value
  persist()
}
function onTextChangeHandler(i, val) {
  checkedItems.value[i].key = val
  persist()
}
function handleRemovedClicked(i) {
...
.gd-checklist__checkbox:disabled {
  cursor: default;
}
...
.gd-checklist__item:hover .gd-checklist__actions {
  opacity: 1;
}
