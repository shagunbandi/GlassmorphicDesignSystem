...
@media (min-width: 480px) {
  .gd-grid { grid-template-columns: repeat(var(--gd-cols-xs, var(--gd-cols, 1)), minmax(0, 1fr)); }
}
@media (min-width: 640px) {
  .gd-grid { grid-template-columns: repeat(var(--gd-cols-sm, var(--gd-cols-xs, var(--gd-cols, 1))), minmax(0, 1fr)); }
}
@media (min-width: 768px) {
  .gd-grid { grid-template-columns: repeat(var(--gd-cols-md, var(--gd-cols-sm, var(--gd-cols-xs, var(--gd-cols, 1)))), minmax(0, 1fr)); }
}
@media (min-width: 1024px) {
  .gd-grid { grid-template-columns: repeat(var(--gd-cols-lg, var(--gd-cols-md, var(--gd-cols-sm, var(--gd-cols-xs, var(--gd-cols, 1))))), minmax(0, 1fr)); }
}
</style>
